...
declare module "lodash" {
    ...
    declare type _Iteratee<T> = (item: T,
                                 index: number,
                                 array: ?Array<T>) => mixed;
    ...
    declare class Lodash {
        ...
        differenceBy<T>(array: ?Array<T>,
                        values: Array<T>,
                        iteratee: ValueOnlyIteratee<T>): T[],
        ...
        intersectionBy<T>(a1: Array<T>,
                          a2: Array<T>,
                          iteratee?: ValueOnlyIteratee<T>): Array<T>,
        intersectionBy<T>(a1: Array<T>,
                          a2: Array<T>,
                          a3: Array<T>,
                          iteratee?: ValueOnlyIteratee<T>): Array<T>,
        ...
        sortedIndexBy<T>(array: ?Array<T>,
                         value: T,
                         iteratee?: ValueOnlyIteratee<T>): number,
        sortedIndexOf<T>(array: ?Array<T>, value: T): number,
        sortedLastIndex<T>(array: ?Array<T>, value: T): number,
        sortedLastIndexBy<T>(array: ?Array<T>,
                             value: T,
                             iteratee?: ValueOnlyIteratee<T>): number,
        ...
        zipWith<T>(a1: NestedArray<T>,
                   a2: NestedArray<T>,
                   iteratee?: Iteratee<T>): Array<T>,
        zipWith<T>(a1: NestedArray<T>,
                   a2: NestedArray<T>,
                   a3: NestedArray<T>,
                   iteratee?: Iteratee<T>): Array<T>,
        ...
        filter<A, T: { [id: string]: A }>(object: T,
                                          predicate?: OPredicate<A, T>): Array<A>,
        find<T>(array: ?Array<T>,
                predicate?: Predicate<T>,
                fromIndex?: number): T | void,
        find<V, A, T: { [id: string]: A }>(object: T,
                                           predicate?: OPredicate<A, T>,
                                           fromIndex?: number): V,
        findLast<T>(array: ?Array<T>,
                    predicate?: Predicate<T>,
                    fromIndex?: number): T | void,
        findLast<V, A, T: { [id: string]: A }>(object: T,
                                               predicate?: OPredicate<A, T>): V,
        flatMap<T, U>(array: ?Array<T>, iteratee?: FlatMapIteratee<T, U>): Array<U>,
        flatMap<T: Object, U>(object: T,
                              iteratee?: OFlatMapIteratee<T, U>): Array<U>,
        flatMapDeep<T, U>(array: ?Array<T>,
                          iteratee?: FlatMapIteratee<T, U>): Array<U>,
        flatMapDeep<T: Object, U>(object: T,
                                  iteratee?: OFlatMapIteratee<T, U>): Array<U>,
        flatMapDepth<T, U>(array: ?Array<T>,
                           iteratee?: FlatMapIteratee<T, U>,
                           depth?: number): Array<U>,
        flatMapDepth<T: Object, U>(object: T,
        ...
        groupBy<V, T>(array: ?Array<T>,
                      iteratee?: ValueOnlyIteratee<T>): { [key: V]: Array<T> },
        groupBy<V, A, T: { [id: string]: A }>(object: T,
                                              iteratee?: ValueOnlyIteratee<A>): { [key: V]: Array<A> },
        ...
        invokeMap<T>(array: ?Array<T>,
                     path: ((value: T) => Array<string> | string) | Array<string> | string,
                     ...args?: Array<any>): Array<any>,
        invokeMap<T: Object>(object: T,
                             path: ((value: any) => Array<string> | string) | Array<string> | string,
                             ...args?: Array<any>): Array<any>,
        keyBy<T, V>(array: ?Array<T>,
                    iteratee?: ValueOnlyIteratee<T>): { [key: V]: ?T },
        keyBy<V, A, I, T: { [id: I]: A }>(object: T,
                                          iteratee?: ValueOnlyIteratee<A>): { [key: V]: ?A },
        map<T, U>(array: ?Array<T>, iteratee?: MapIterator<T, U>): Array<U>,
        map<V, T: Object, U>(object: ?T,
                             iteratee?: OMapIterator<V, T, U>): Array<U>,
        map(str: ?string,
            iteratee?: (char: string, index: number, str: string) => any): string,
        orderBy<T>(array: ?Array<T>,
                   iteratees?: Array<Iteratee<T>> | string,
                   orders?: Array<"asc" | "desc"> | string): Array<T>,
        orderBy<V, T: Object>(object: T,
                              iteratees?: Array<OIteratee<*>> | string,
                              orders?: Array<"asc" | "desc"> | string): Array<V>,
        partition<T>(array: ?Array<T>, predicate?: Predicate<T>): NestedArray<T>,
        partition<V, A, T: { [id: string]: A }>(object: T,
                                                predicate?: OPredicate<A, T>): NestedArray<V>,
        reduce<T, U>(array: ?Array<T>,
                     iteratee?: (accumulator: U,
                                 value: T,
                                 index: number,
                                 array: ?Array<T>) => U,
                     accumulator?: U): U,
        reduce<T: Object, U>(object: T,
                             iteratee?: (accumulator: U, value: any, key: string, object: T) => U,
                             accumulator?: U): U,
        reduceRight<T, U>(array: ?Array<T>,
                          iteratee?: (accumulator: U,
                                      value: T,
                                      index: number,
                                      array: ?Array<T>) => U,
                          accumulator?: U): U,
        reduceRight<T: Object, U>(object: T,
                                  iteratee?: (accumulator: U, value: any, key: string, object: T) => U,
                                  accumulator?: U): U,
        reject<T>(array: ?Array<T>, predicate?: Predicate<T>): Array<T>,
        reject<V: Object, A, T: { [id: string]: A }>(object: T,
                                                     predicate?: OPredicate<A, T>): Array<V>,
        ...
        some<A, T: { [id: string]: A }>(object?: ?T,
                                        predicate?: OPredicate<A, T>): boolean,
        sortBy<T>(array: ?Array<T>, ...iteratees?: Array<Iteratee<T>>): Array<T>,
        sortBy<T>(array: ?Array<T>, iteratees?: Array<Iteratee<T>>): Array<T>,
        sortBy<V, T: Object>(object: T,
                             ...iteratees?: Array<OIteratee<T>>): Array<V>,
        ...
        debounce(func: Function,
                 wait?: number,
                 options?: DebounceOptions): Function,
        ...
        throttle(func: Function,
                 wait?: number,
                 options?: ThrottleOptions): Function,
        ...
        cloneDeepWith<T, U>(value: T,
                            customizer?: ?(value: T, key: number | string, object: T, stack: any) => U): U,
        cloneWith<T, U>(value: T,
                        customizer?: ?(value: T, key: number | string, object: T, stack: any) => U): U,
        conformsTo<T: { [key: string]: mixed }>(source: T,
                                                predicates: T & { [key: string]: (x: any) => boolean }): boolean,
        ...
        isEqualWith<T, U>(value: T,
                          other: U,
                          customizer?: (objValue: any,
                                        otherValue: any,
                                        key: number | string,
                                        object: T,
                                        other: U,
                                        stack: any) => boolean | void): boolean,
        ...
        isMatchWith<T: Object, U: Object>(object: T,
                                          source: U,
                                          customizer?: (objValue: any,
                                                        srcValue: any,
                                                        key: number | string,
                                                        object: T,
                                                        source: U) => boolean | void): boolean,
        ...
        assignInWith<T: Object, A: Object>(object: T,
                                           s1: A,
                                           customizer?: (objValue: any,
                                                         srcValue: any,
                                                         key: string,
                                                         object: T,
                                                         source: A) => any | void): Object,
        assignInWith<T: Object, A: Object, B: Object>(object: T,
                                                      s1: A,
                                                      s2: B,
                                                      customizer?: (objValue: any,
                                                                    srcValue: any,
                                                                    key: string,
                                                                    object: T,
                                                                    source: A | B) => any | void): Object,
        assignInWith<T: Object, A: Object, B: Object, C: Object>(object: T,
                                                                 s1: A,
                                                                 s2: B,
                                                                 s3: C,
                                                                 customizer?: (objValue: any,
                                                                               ...
                                                                               key: string,
                                                                               object: T,
                                                                               source: A | B | C) => any | void): Object,
        assignInWith<T: Object, A: Object, B: Object, C: Object, D: Object>(object: T,
                                                                            s1: A,
                                                                            s2: B,
                                                                            s3: C,
                                                                            s4: D,
                                                                            customizer?: (objValue: any,
                                                                                          ...
                                                                                          key: string,
                                                                                          object: T,
                                                                                          source: A | B | C | D) => any | void): Object,
        assignWith<T: Object, A: Object>(object: T,
                                         s1: A,
                                         customizer?: (objValue: any,
                                                       srcValue: any,
                                                       key: string,
                                                       object: T,
                                                       source: A) => any | void): Object,
        assignWith<T: Object, A: Object, B: Object>(object: T,
                                                    s1: A,
                                                    s2: B,
                                                    customizer?: (objValue: any,
                                                                  srcValue: any,
                                                                  ...
                                                                  object: T,
                                                                  source: A | B) => any | void): Object,
        assignWith<T: Object, A: Object, B: Object, C: Object>(object: T,
                                                               s1: A,
                                                               s2: B,
                                                               s3: C,
                                                               customizer?: (objValue: any,
                                                                             ...
                                                                             object: T,
                                                                             source: A | B | C) => any | void): Object,
        assignWith<T: Object, A: Object, B: Object, C: Object, D: Object>(object: T,
                                                                          s1: A,
                                                                          s2: B,
                                                                          s3: C,
                                                                          s4: D,
        ...
        extendWith<T: Object, A: Object>(object: T,
                                         s1: A,
                                         customizer?: (objValue: any,
                                                       srcValue: any,
                                                       key: string,
                                                       object: T,
                                                       source: A) => any | void): Object,
        extendWith<T: Object, A: Object, B: Object>(object: T,
                                                    s1: A,
                                                    s2: B,
                                                    customizer?: (objValue: any,
                                                                  srcValue: any,
                                                                  ...
                                                                  object: T,
                                                                  source: A | B) => any | void): Object,
        extendWith<T: Object, A: Object, B: Object, C: Object>(object: T,
                                                               s1: A,
                                                               s2: B,
                                                               s3: C,
                                                               customizer?: (objValue: any,
                                                                             ...
                                                                             object: T,
                                                                             source: A | B | C) => any | void): Object,
        extendWith<T: Object, A: Object, B: Object, C: Object, D: Object>(object: T,
                                                                          s1: A,
                                                                          s2: B,
                                                                          s3: C,
                                                                          s4: D,
                                                                          customizer?: (objValue: any,
                                                                                        ...
                                                                                        object: T,
                                                                                        source: A | B | C | D) => any | void): Object,
        findKey<A, T: { [id: string]: A }>(object?: ?T,
                                           predicate?: OPredicate<A, T>): string | void,
        findLastKey<A, T: { [id: string]: A }>(object?: ?T,
                                               predicate?: OPredicate<A, T>): string | void,
        ...
        mergeWith<T: Object, A: Object>(object: T,
                                        customizer?: (objValue: any,
                                                      srcValue: any,
                                                      key: string,
                                                      object: T,
                                                      source: A) => any | void): Object,
        mergeWith<T: Object, A: Object, B: Object>(object: T,
                                                   s1: A,
                                                   s2: B,
                                                   customizer?: (objValue: any,
                                                                 srcValue: any,
                                                                 ...
                                                                 object: T,
                                                                 source: A | B) => any | void): Object,
        mergeWith<T: Object, A: Object, B: Object, C: Object>(object: T,
                                                              s1: A,
                                                              s2: B,
                                                              s3: C,
                                                              customizer?: (objValue: any,
                                                                            ...
                                                                            object: T,
                                                                            source: A | B | C) => any | void): Object,
        mergeWith<T: Object, A: Object, B: Object, C: Object, D: Object>(object: T,
                                                                         s1: A,
                                                                         s2: B,
                                                                         s3: C,
                                                                         s4: D,
        ...
        omit(object?: ?Object, props: Array<string>): Object,
        omitBy<A, T: { [id: string]: A }>(object?: ?T,
                                          predicate?: OPredicate<A, T>): Object,
        pick(object?: ?Object, ...props: Array<string>): Object,
        pick(object?: ?Object, props: Array<string>): Object,
        pickBy<A, T: { [id: string]: A }>(object?: ?T,
                                          predicate?: OPredicate<A, T>): Object,
        ...
        replace(string?: string,
                ...
                replacement: ((string: string) => string) | string): string,
        ...
        defaultTo<T1: string | boolean | Object, T2>(value: T1,
                                                     defaultValue: T2): T1,
        ...
        mixin<T: Function | Object>(object?: T,
                                    source: Object,
